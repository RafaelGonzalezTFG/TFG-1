        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="card mb-4">
              ...
              <div class="card-body">
                <div id="pagosMesAnio"> <!-- Gráfica de pagos por mes (Highcharts u otra librería) --> </div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card mb-4">
              ...
              <div class="card-body">
                <div id="graficaMes"> <!-- Gráfica de ventas por mes (Highcharts u otra librería) --> </div>
              </div>
            </div>
          </div>
        </div>
  ...
  <script>
    ...
    Highcharts.chart('pagosMesAnio', {
      ...
      series: [{
        name: 'Ventas',
        data: [
          { name: 'Tarjeta de Crédito', y: 61.41 },
          { name: 'PayPal', y: 11.84 },
          { name: 'Transferencia Bancaria', y: 10.85 }
        ]
      }]
    });
