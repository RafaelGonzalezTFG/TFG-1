...
<body>
    <div style="display: none; font-size: 1px; color: #FFFFFF; line-height: 1px; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden;"> We're thrilled to have you here! Get ready to dive into your new account. </div>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td bgcolor="#ffffff" align="center" style="padding: 20px 30px 30px 30px;">
                                        <form action="../controllers/User_Controller.php?action=activate" method="post">
                                            ...
                                            <button type="submit" class="btn btn-primary mt-3"  style="font-size: 20px; color: #ffffff; background-color: #FF4E1F; padding: 15px 25px; border-radius: 2px; border: 1px solid #FF4E1F; display: inline-block;" >Activar Cuenta</button>
                    ...
                    <tr>
                        <td bgcolor="#ffffff" align="left" style="padding: 0px 30px 40px 30px; border-radius: 0px 0px 4px 4px; color: #666666; font-size: 18px; font-weight: 400; line-height: 25px;">
                            ...
                            <div>
                                <a style="padding-right:10px" href="https://www.instagram.com/templo_wargames/?hl=en"><img src="https://cdn-icons-png.flaticon.com/512/2111/2111463.png" width="25"></a>
                            </div>
                        </td>
                    </tr>
                </table>
